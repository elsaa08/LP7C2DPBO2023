    ...
    public synchronized void keyReleased(KeyEvent e)
    {
        ...
        if(game.isRunning())
        {
            ...
            if((key == KeyEvent.VK_W) || (key == KeyEvent.VK_UP))
            {
                ...
                if((this.newkey != KeyEvent.VK_W) && (this.newkey != KeyEvent.VK_UP)){
                   game.scakhir += 1;
                }
            ...
            if((key == KeyEvent.VK_A) || (key == KeyEvent.VK_LEFT))
            {
                ...
                if((this.newkey != KeyEvent.VK_A) && (this.newkey != KeyEvent.VK_LEFT)){
                    game.scakhir += 1;
            ...
            if((key == KeyEvent.VK_S) || (key == KeyEvent.VK_DOWN))
            {
                ...
                temp.setVelY(0);
                if((this.newkey != KeyEvent.VK_S) && (this.newkey != KeyEvent.VK_DOWN)){
                    game.scakhir += 1;
                }
            }
            if((key == KeyEvent.VK_D) || (key == KeyEvent.VK_RIGHT))
            {
                ...
                temp.setVelX(0);
                if((this.newkey != KeyEvent.VK_D) && (this.newkey != KeyEvent.VK_RIGHT)){
                    game.scakhir += 1;
                }
            }
            this.newkey = key;
